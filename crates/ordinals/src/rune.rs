...
mod tests {
  ...
  fn round_trip() {
    ...
    case(10525960444479489710294726473748, "THEBESTRUNETHEBESTRUNE");
  }
  ...
  fn commitment() {
    ...
    case(65536, &[0, 0, 1]);
    case(
      10525960444479489710294726473748,
      &[20, 248, 161, 121, 105, 205, 179, 14, 126, 104, 54, 219, 132],
    );
  ...
  fn ip_to_u128() {
    ...
    let input = &[
      20, 248, 161, 121, 105, 205, 179, 14, 126, 104, 54, 219, 132, 0, 0, 0,
    ];
    // let ip_bytes: &[u8; 16] = input.try_into().unwrap();

    let num = u128::from_le_bytes(*input);
    assert_eq!(num, 100)
  }
}
